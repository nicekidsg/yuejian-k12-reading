...
- Preserve source-text capitalization when matching vocabulary. Proper names and character names must use child-safe, story-specific explanations instead of an unrelated lower-case dictionary sense; external dictionaries are labeled verification links rather than silently copied definitions.
